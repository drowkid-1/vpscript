...
autoop(){
[[ -e /root/name ]] && figlet -p -f smslant < /root/name | lolcat || echo -e "\033[7;49;35m    ${TTini} New 🚀|SpaceNetwork|🚀${TTcent}VPS ${TTfin}      \033[0m"
...
function mtraff(){
[[ -e /root/name ]] && figlet -p -f smslant < /root/name | lolcat || echo -e "\033[7;49;35m    ${TTini} New drowkid01${TTcent}VPS ${TTfin}      \033[0m"
echo -e "\033[1;37m  ${RRini} Reseller : $(cat < /bin/ejecutar/menu_credito) 2022 ${RRfin}\033[0m"
msg -bar1 
...
case $ppp in
	...
	1)
		...
		1)reiniciar_ser;;
		2)
		[[ -e /root/name ]] && figlet -p -f smslant < /root/name | lolcat || echo -e "\033[7;49;35m    =====>>►► 🚀|SpaceNetwork|🚀◄◄<<=====      \033[0m"
